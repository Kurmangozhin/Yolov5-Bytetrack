...
void YOLODetector::preprocessing(cv::Mat &image, float*& blob, std::vector<int64_t>& inputTensorShape)
{
    ...
    util::letterbox(resizedImage, resizedImage, this->inputImageShape,
                                                    ...
                                                    const float& confThreshold, const float& iouThreshold)
{
    ...
    for (int idx : indices)
    {
        ...
        util::scaleCoords(resizedImageShape, det.box, originalImageShape);
                                            ...
                                            const float& iouThreshold = 0.45)
{
    ...
    size_t inputTensorSize = util::vectorProduct(inputTensorShape);
